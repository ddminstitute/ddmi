...
<section class="hero-section pt-5">
    <div class="container position-relative" style="z-index:2;padding-top:6rem;padding-bottom:6rem">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <div class="hero-badge mb-4"><i class="bi bi-shield-check"></i> FDIC Insured · Bank-Grade Security</div>
                ...
                <div class="hero-stats">
                    ...
                    <div class="hero-stat"><div class="hero-stat-num">$2B+</div><div class="hero-stat-label">Assets Managed</div></div>
...
<section class="bg-soft py-4 border-bottom">
    <div class="container">
        ...
        <div class="d-flex justify-content-center align-items-center gap-4 flex-wrap">
            @foreach(['FDIC Insured','PCI DSS Certified','ISO 27001','256-bit SSL','SWIFT Member'] as $badge)
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            $services = [
                ...
                ['icon'=>'bi-arrow-left-right','color'=>'#00897B','bg'=>'rgba(0,137,123,.08)','title'=>'Fund Transfers','desc'=>'Instant domestic & international transfers with real-time tracking and low fees.'],
...
<section class="py-5 bg-grid" style="padding:5rem 0!important">
    <div class="container">
        ...
        <div class="row g-4 mb-4">
            @php
            $plans = [
                ['name'=>'Savings Account','icon'=>'bi-piggy-bank','color'=>'#1565C0','rate'=>'4.5% APY','fee'=>'$0/month','min'=>'$100','badge'=>null,'features'=>['High-yield interest','Unlimited deposits','3 free withdrawals/mo','Online & mobile banking','FDIC insured up to $250K']],
                ['name'=>'Checking Account','icon'=>'bi-credit-card-2-front','color'=>'#fff','rate'=>'0.5% APY','fee'=>'$0/month','min'=>'$0','badge'=>'Most Popular','features'=>['Unlimited transactions','Free debit card','Overdraft protection','Bill pay included','ATM fee rebates']],
                ['name'=>'Current Account','icon'=>'bi-building','color'=>'#1565C0','rate'=>'1.0% APY','fee'=>'$15/month','min'=>'$500','badge'=>null,'features'=>['Business-grade features','Multiple signatories','Bulk payment support','Dedicated manager','Priority support']],
                ['name'=>'Fixed Deposit','icon'=>'bi-safe','color'=>'#1565C0','rate'=>'Up to 8.5%','fee'=>'$0 fees','min'=>'$1,000','badge'=>'Best Returns','features'=>['Guaranteed returns','Flexible tenures 6–60 mo','Auto-renewal option','No market risk','Early withdrawal option']],
            ];
            @endphp
...
<section class="py-5" style="padding:5rem 0!important">
    <div class="container">
        ...
        <div class="row g-4">
            @php
            $testimonials = [
                ['name'=>'Emily Thompson','role'=>'Freelance Designer','rating'=>5,'text'=>'CoreAxis completely changed how I manage my money. The savings account interest is incredible and the app is super intuitive.','initials'=>'ET'],
                ['name'=>'James Rodriguez','role'=>'Small Business Owner','rating'=>5,'text'=>'Got my business loan approved within 48 hours. The process was seamless and the EMI calculator helped me plan perfectly.','initials'=>'JR'],

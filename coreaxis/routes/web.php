...
Route::middleware('auth')->group(function () {
    ...
    Route::post('customers/{customer}/portal-account', [CustomerController::class, 'createPortalAccount'])->name('customers.portal-account');
...
Route::middleware('auth')->prefix('gl')->name('gl.')->group(function () {
    Route::get('chart-of-accounts', [GeneralLedgerController::class, 'chartOfAccounts'])->name('chart-of-accounts');
    Route::post('chart-of-accounts', [GeneralLedgerController::class, 'storeAccount'])->name('accounts.store');
    Route::get('journal-entries', [GeneralLedgerController::class, 'journalEntries'])->name('entries');
    Route::get('journal-entries/{journalEntry}', [GeneralLedgerController::class, 'showEntry'])->name('entries.show');
    Route::get('trial-balance', [GeneralLedgerController::class, 'trialBalance'])->name('trial-balance');
    Route::get('ledger', [GeneralLedgerController::class, 'ledger'])->name('ledger');
});
...
Route::middleware(['auth', \App\Http\Middleware\CustomerPortal::class])
    ->prefix('portal')
    ->name('portal.')
    ->group(function () {
        Route::get('/', [PortalController::class, 'dashboard'])->name('dashboard');
        Route::get('/accounts', [PortalController::class, 'accounts'])->name('accounts');
        Route::get('/transactions', [PortalController::class, 'transactions'])->name('transactions');
        Route::get('/loans', [PortalController::class, 'loans'])->name('loans');
        Route::get('/deposits', [PortalController::class, 'deposits'])->name('deposits');
        Route::get('/grievances', [PortalController::class, 'grievances'])->name('grievances');
        Route::post('/grievances', [PortalController::class, 'raiseGrievance'])->name('grievances.store');
        Route::get('/profile', [PortalController::class, 'profileForm'])->name('profile');
        Route::post('/profile/password', [PortalController::class, 'changePassword'])->name('profile.password');
    });
